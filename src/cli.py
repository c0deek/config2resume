...
@click.command()
@click.option('--config', default='./config/sample_config.yaml', help='Path to config file')
@click.option('--template', default='./templates/sample_template.html', help='Path to config file')
